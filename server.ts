...
app.get('/relatorio-vendas', async (request, reply) => {
  const vendas = [
    { 
      data: '2025-05-26', 
      cliente: 'João Pedro', 
  ...
  // Borda e alinhamento para todas as células
  ...
  // Proteger a planilha com uma senha (simula "somente leitura")
  ...
  reply
    ...
    .header('Content-Disposition', 'attachment; filename=relatorio-vendas.xlsx')
    .send(buffer);
});
